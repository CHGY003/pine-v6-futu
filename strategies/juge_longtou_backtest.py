"""Batch yfinance backtest for the Juge longtou indicator signals."""
...
RESULT_PATH = ROOT / "results" / "juge_longtou_backtest_summary.csv"
...
def main():
    ...
    print(f"MODES: {MODES}")
    print(f"HOLD_DAYS_LIST: {HOLD_DAYS_LIST}")
